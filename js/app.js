...
var checkProm = true;
var valueColorRed = 2.0;
var valueColorGreen = 2.0;
var valueColorBlue = 2.0;
...
controlCompared.addEventListener("touchstart", (e) => {
  mousedown = true;
});

// Mostrar todos los evento del comparador
...
controlCompared.addEventListener("touchend", (e) => {
  mousedown = false;
});
controlCompared.addEventListener("touchcancel", (e) => {
  mousedown = false;
});
